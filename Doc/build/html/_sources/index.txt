...
and generate an EPUB3 file for off-line reading. ResPec “sources” are transformed into HTML on the fly by this
service using a separate Web Service set up (at W3C) for that purpose.  Style sheets, images, scripts, etc.,
