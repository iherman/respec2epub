# -*- coding: utf-8 -*-
"""
Templates, i.e., "scaffold" XML content; these are finalized, and then dumped into the
final content directory, by the :py:class:`.Package` instance.

.. py:data:: NAV

  XML scaffolding code for the ``nav`` file, i.e., the new style table of content

.. py:data:: TOC

  XML scaffolding code for the ``ncx`` file, i.e.e, the old style table of content

.. py:data:: PACKAGE

  XML scaffolding code for the package file (``package.opf``)
...
<html lang="en-us" xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div id="title">
      ...
      <p class="disclaimer">Note: this ePub edition does <em>not</em> represent the authoritative texts of the specifications; please consult the <a href="#list_originals">originals</a> on the <a href="http://www.w3.org/TR/">W3C Web Site</a> for those</p>
      <p class="copyright"><a href="http://www.w3.org/Consortium/Legal/ipr-notice#Copyright">Copyright</a>
      © of the original documents: <span id="cpdate">2013</span> W3C<sup>®</sup> (<a href="http://www.mit.edu">MIT</a>, <a href="http://www.ercim.eu/">ERCIM</a>,
	  ...
	  <div id="originals_block">
        <h3 id="list_originals">Original, authoritative documents:</h3>
        <ol id="originals">
        </ol>
      </div>
    </div>
